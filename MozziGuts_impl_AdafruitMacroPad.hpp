 ...
 * running smoothly. */
#define LOOP_YIELD tight_loop_contents();
...
#endif
  // absolute_time_t next_audio_update = make_timeout_time_us(uint64_t(1000000l / AUDIO_RATE));
  add_repeating_timer_us(MICROS_PER_AUDIO_TICK, timerCallback, NULL, &timer);
}
